...
<div class="step-header">
  ...
  <div class="step-nav">
    <a href="{{ '/cdt502/steps/step-04-customer-clustering/' | relative_url }}">← 上一步</a>
    <a href="{{ '/cdt502/steps/step-06-churn-prediction/' | relative_url }}">下一步 →</a>
  </div>
</div>
...
<div class="bottom-step-nav">
  <a href="{{ '/cdt502/steps/step-04-customer-clustering/' | relative_url }}">← 客户聚类</a>
